    ...
    <ul class="nav-items">
      ...
      <li>
        ...
        <ul>
          ...
          <li><a href="pages/citala.php">Citalá</a></li>
          ...
          <li><a href="pages/rsanandres.php">Ruinas de San Andrés</a></li>
          <li><a href="pages/volcanchap.php">Volcán Chaparrastique</a></li>
        </ul>
      </li>
